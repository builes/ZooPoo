...
/**
 * The Main class is the entry point of the application. It provides a menu-driven interface
 * for users to interact with different animals (Tiger, Dolphin, Penguin) and manipulate their properties.
 */
public class Main {
     ...
     * @return the user's choice of animal
     */
